...
(
    ...
    msg_id                     VARCHAR(20)                                  NULL COMMENT '전송 메시지 id',
    is_success                 CHAR(1)                                  NOT NULL COMMENT '알림톡 전송 성공 여부 (T/F)',
    created_at                 DATETIME(6) DEFAULT CURRENT_TIMESTAMP(6) NOT NULL,
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4 COMMENT '알림톡 발송 결과 정보';

CREATE INDEX `idx-alim_talk_result-created_at`
    ON alim_talk_result (created_at);